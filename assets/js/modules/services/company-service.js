...
class CompanyService {
    constructor() {
        ...
        this.defaultInfo = {
            ...
            contact: {
                ...
                postalCode: '214196',
                phone: '+86 18217576072',
                whatsapp: '+86 13656157230',
                email: 'ciki@diamond-auto.com'
            }
        };
    }
    ...
    updatePageElements(options = {}) {
        ...
        this._updateElement('company-whatsapp-link', (element) => {
            const whatsappNumber = (contactInfo.whatsapp || contactInfo.phone).replace(/\s+/g, '');
    ...
    _getLocalizedAddress() {
        ...
        if (window.i18nManager && window.i18nManager.getCurrentLanguage) {
            ...
            if (currentLang === 'en-US') {
                // 英文地址
                return window.i18nManager.t('contact.address_full') ||
    ...
    getWhatsAppNumber() {
        const contactInfo = this.getContactInfo();
        const whatsapp = contactInfo.whatsapp || contactInfo.phone || '+86 13656157230';
